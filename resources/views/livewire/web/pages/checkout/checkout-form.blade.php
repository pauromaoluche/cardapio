                                ...
                                @foreach ($cartList as $item)
                                    <li class="list-group-item d-flex justify-content-between lh-sm">
                                        <div>
                                            ...
                                            <small class="text-body-secondary">Quantidade:
                                                {{ $item['quantity'] }}</small>
                                        </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="whatsapp"
                                        placeholder="(xx) xxxxx-xxxx" wire:model.defer="form.whatsapp">
                                    @error('form.whatsapp')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12" x-data="{
                                        ...
                                        <div class="alert alert-info mt-3" x-show="payment_method === 'pix'">
                                            Após o Finalizar o pedido, você ira receber uma mensagem informando seu
                                            pedido,
                                            assim que receber envie o comprovante de pagamentom, caso não receba, envie
                                            o
